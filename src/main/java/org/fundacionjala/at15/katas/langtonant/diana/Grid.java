...
public class Grid {
    ...
    /**
     * Obtener la posicion en la matriz
     */
    ...
    public int getRows() { // devuelve numero de filas
        return grid.length;
    }

    public int getColumns() { // devuelve numero de columnas
